...
const Contact = () => {   
    ...
    const handleContactForm = e => {
        ...
        emailjs.sendForm('service_s19q3q3','template_8fvu88d',form.current,'user_l1P4sZbLgP2EXyIi68bTB')
        .then((result) => {
            ...
            <div className="contact-form">
                <form ref={form} onSubmit={handleContactForm}>
                    ...
                    <div className="form-desing">
                        ...
                        <textarea name="userMessage" id="userMessage"  rows="8" placeholder="Enter Your Message" ></textarea>
                    </div>
                    <button type="submit" id="contact-submit-btn">Send <i class="fas fa-paper-plane"></i></button>
                </form>
            </div>
        </div>
    );
