        ...
        <div data-aos="zoom-out-down" data-aos-duration="2000" className="single-portfolio">
            ...
            <div className="portfolio-info">                
                <div className="portfolio-link">
                    <span><a href={githubLink} target="_blank"><i class="fab fa-github"></i> Github Link</a></span>
                    <span><a href={liveSiteLInk} target="_blank"><i class="fab fa-firefox-browser"></i> Live Link</a></span>
                </div>
