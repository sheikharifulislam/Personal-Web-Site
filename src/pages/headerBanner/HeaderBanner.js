                ...
                <div className="header-banner-container">
                    <div className="header-banner-text">
                        ...
                        <div className="header-banner-details">
                            ...
                            <Fade left>
                                <h2>
                                    <span id="developer-first-name">Sheikh</span>{" "}
                                    <span id="developer-mid-name">Ariful</span>{" "}
                                    <span id="developer-last-name">Islam</span>
                                </h2>
                            </Fade>
                            <p id="developer-simple-details">
                                I am a MERN Stack Developer. I Will Create a Design and Development that can give value
                                to your product.
                            </p>
